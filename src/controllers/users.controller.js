...
const getUserById = async (req, res) => {
    ...
    if (id !== userId) {
        return res.status(403).json({ message: 'Você não tem permissão para visualizar essas informações.' });
    }
...
const updateUser = async (req, res) => {
    ...
    if (id !== userId) {
        return res.status(403).json({ message: 'Você não tem permissão para atualizar essas informações.' });
    }
...
const deleteUser = async (req, res) => {
    ...
    if (id !== userId) {
        return res.status(403).json({ message: 'Você não tem permissão para deletar essas informações.' });
    }
